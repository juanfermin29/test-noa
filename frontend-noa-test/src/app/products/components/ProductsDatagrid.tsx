...
async function getProducts(category?: string): Promise<ShortProduct[]> {
  ...
  const url = `${process.env.NEXT_PUBLIC_STRAPI_BASE_API}/api/products?fields[0]=name&fields[1]=price&fields[2]=createdAt&fields[3]=frontImage&${category && 'filters[categories][name][$eq]=' + category}`
